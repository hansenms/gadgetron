...
find_path(MKL_PATH "include/mkl.h" PATHS ${MKLROOT_PATH}/mkl "C:/Program Files (x86)/Intel/oneAPI/mkl/latest" "C:/Program Files (x86)/IntelSWTools/compilers_and_libraries/windows/mkl")
...
if (MKL_FOUND)
    ...
    if (EXISTS "${MKL_PATH}/../../compiler/latest/windows/compiler/lib/intel64")
        set(MKL_COMPILER_LIB_DIR "${MKL_PATH}/../../compiler/latest/windows/compiler/lib/intel64")
        message("------>>>   FOUND COMPILER LIB ${MKL_COMPILER_LIB_DIR}")
    else ()
        if (WIN32)
            if (EXISTS "${MKL_PATH}/../../compiler/latest/windows/compiler/lib/intel64_win")
                set(MKL_COMPILER_LIB_DIR "${MKL_PATH}/../../compiler/latest/windows/compiler/lib/intel64_win")
            endif ()
        else ()
            if (EXISTS "${MKL_PATH}/../../compiler/latest/lib/intel64_lin")
                    set(MKL_COMPILER_LIB_DIR "${MKL_PATH}/../../compiler/latest/lib/intel64_lin")
            endif ()
        endif ()
    endif ()
        ...
        if (MKL_COMPILER_LIB_DIR)
            ...
            message(FATAL_ERROR "MKL compiler lib dir is not found")
